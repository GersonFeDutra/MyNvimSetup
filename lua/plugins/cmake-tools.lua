...
return {
    ...
    keys = {
        {
            prefix,
            desc = require("astronvim.utils").get_icon("FileNew", 1, true) .. "CMake",
            mode = { "n" }
        },
        { prefix .. "g", cmd = "CMakeGenerate", desc = "Generate", },
        { prefix .. "b", cmd = "CMakeBuild",    desc = "Build", },
        { prefix .. "r", cmd = "CMakeRun",      desc = "Run", },
    },
    opts = {
